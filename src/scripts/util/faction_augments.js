...
const AUGMENT_DETAILS = {
 ...
 ,"Embedded Netburner Module": {
   ...
   ,restricted: true
   ,categories: ["Hacking"]
   ,factions: ["NiteSec","The Black Hand","BitRunners","MegaCorp","ECorp"]
  }
 ,"Embedded Netburner Module Analyze Engine": {
   ...
   ,restricted: true
   ,categories: ["Hacking"]
   ,factions: ["MegaCorp","Daedalus","The Covenant","Illuminati","ECorp"]
 ...
 ,"Embedded Netburner Module Core Implant": {
   ...
   ,restricted: true
   ,categories: ["Hacking"]
   ,factions: ["The Black Hand","BitRunners","MegaCorp","ECorp"]
   ,prereq: ["Embedded Netburner Module"]
  }
 ,"Embedded Netburner Module Core V2 Upgrade": {
   ...
   ,restricted: true
   ,categories: ["Hacking"]
   ,factions: ["BitRunners","MegaCorp","OmniTek Incorporated","ECorp"]
 ...
 ,"Neuralstimulator": {
   ...
   ,restricted: true
   ,categories: ["Hacking"]
   ,factions: ["Sector-12","Ishima","New Tokyo","Chongqing","The Black Hand","Volhaven","Four Sigma","Aevum","Bachman & Associates"]
  }
  ,"BitRunners Neurolink": {
 ...
 ,"PC Direct-Neural Interface": {
   ...
   ,factions: ["Four Sigma","OmniTek Incorporated","ECorp"]
  }
 ,"PC Direct-Neural Interface Optimization Submodule": {
    base_cost: 4500000000
   ,base_rep: 500000
 ...
 ,"FocusWire": {
   ...
   ,factions: ["Four Sigma","Bachman & Associates"]
  }
 ,"PCMatrix": {
 ...
 ,"SmartJaw": {
    base_cost: 2750000000
   ,base_rep: 375000
   ,unique: true
   ,restricted: true
   ,categories: ["Charisma","Reputation"]
 ...
 ,"Enhanced Social Interaction Implant": {
   ...
   ,restricted: true
   ,categories: ["Charisma"]
   ,factions: ["Four Sigma","OmniTek Incorporated","Bachman & Associates"]
  }
 ,"TITN-41 Gene-Modification Injection": {
    base_cost: 190000000
   ,base_rep: 25000
 ...
 ,"Nuoptimal Nootropic Injector Implant": {
   ...
   ,restricted: true
   ,categories: ["Reputation"]
   ,factions: ["Tian Di Hui","New Tokyo","Chongqing","Volhaven","Four Sigma","Bachman & Associates"]
  }
 ,"Speech Enhancement": {
    base_cost: 12500000
   ,base_rep: 2500
   ...
   ,factions: ["Tian Di Hui","Four Sigma","Speakers for the Dead","Bachman & Associates"]
  }
 ,"Wired Reflexes": {
    base_cost: 2500000
   ,base_rep: 1250
